...
struct FUNCPTR {
  ...
  S32 (*SL_AudioStreamRecordStart_p)(SL_AUDIOREC_FORMAT enFormat);
  S32 (*SL_AudioStreamRecordStop_p)(VOID);
  ...
  S32 (*SL_TtsPlay_p)(U8* pucText, U32 ulSize, SL_TTS_PLAY_FINISH_CB stPlayCb);
  S32 (*SL_TtsStop_p)(void);
  S32 (*SL_TtsQueryStatus_p)(void);
  S32 (*SL_TtsSetPlaySpeed_p)(U8 ucTtsSpeed);
