...
typedef void (*SL_BT_CALIBDC_CB)(S32 slResult);
typedef void (*SL_BT_READDCREG_CB)(S32 slResult, U16 data);
...
typedef struct{
	...
	SL_BT_CALIBDC_CB pstSlBtCalibDc;
	SL_BT_READDCREG_CB pstSlBtReadCalibDcReg;
}SL_BT_CALLBACK;
...
S32 SL_BtSetDcCalib(void);
S32 SL_BtGetDcCalibRegVal(void);
