...
unsigned char GnssDataParse(void)
{
	...
	if((index > 0) && (p + 100) < endof(GnssDataBuf))     //
	{
		...
		//SL_Print("The GSP satellite_view_num :%d\r\n",TempGnssData.satellite_view_num);
		//SL_Print("The BD  satellite_view_num :%d\r\n",TempGnssData.satellite_view_num1);
