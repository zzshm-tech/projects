...
typedef void (*SL_NW_SET_REG_MANUAL_CB)(S32 slResult);
typedef struct
{
...
typedef void (*SL_JAMM_DETECT_CB)(SL_JAMM_STATUS jammStatus);
extern SL_JAMM_DETECT_CB g_jammDetectCb;
typedef enum
{
    SL_PMD_LEDR = 0,
    SL_PMD_LEDG,
...
#define SL_JammFuncInit AA.SL_JammFuncInit_p
#define SL_JammFuncEnable AA.SL_JammFuncEnable_p
#define SL_JammFuncDisable AA.SL_JammFuncDisable_p
#define SL_SetCustomizationSettings AA.SL_SetCustomizationSettings_p
#define SL_GetCustomizationSettings AA.SL_GetCustomizationSettings_p
#define SL_PmdSetLevel AA.SL_PmdSetLevel_p
#define SL_NwSetRegistrationManual AA.SL_NwSetRegistrationManual_p
#endif
