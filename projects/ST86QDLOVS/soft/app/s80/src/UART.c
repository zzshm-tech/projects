...
static unsigned char	 	com1_recv_buf[1024];          //接收缓冲区  串口1  UART1
...
static unsigned char	 	com2_recv_buf[1024];          //UART2接收缓冲区
...
{
	SL_UartSetBaudRate(SL_UART_1, SL_UART_BAUD_RATE_9600);
...
/******************************************************************
**	函数名称:void UART1_Recv_Data(unsigned char *dest,unsigned short int data_len)
**	功能描述:UART1接收服务函数
******************************************************************/
...
/******************************************************************
**	函数名称:void UART2_Recv_Data(unsigned char *dest,unsigned short int data_len)
**	功能描述:接收到数据入库
******************************************************************/
