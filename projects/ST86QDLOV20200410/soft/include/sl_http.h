...
SL_HTTP_CALLBACK* SL_Http_GetCb(void);
S32 SL_HTTP_Callback_Init(SL_HTTP_CALLBACK *cb);
...
*                       -1: Fail
******************************************************************************/
S32 SL_Http_Set_Para(char *pUrl, char *pUserName, char *pPassword, char *pUserAgent, SL_HTTP_RequestType ReqType);
...
*                       -1: Fail
******************************************************************************/
S32 SL_Http_Send_Data(char *pData, SL_HTTP_DataType type);
