...
****************************************************/
SL_FTP_CALLBACK* SL_Ftp_GetCb(void); 
S32 SL_Ftp_Callback_Init(SL_FTP_CALLBACK *cb);
...
*                        -1: Fail
******************************************************************************/
S32 SL_Ftp_Open(SL_FTP_Connect_Info* pstConnectInfo);
...
*                        -1: Fail
******************************************************************************/
S32 SL_Ftp_Download(U8 *pu8RemoteFile, SL_FTP_File_TYPE emFileType);
...
*                        -1: Fail
******************************************************************************/
S32 SL_Ftp_Upload(U8 *pu8FileName, U8 *pFileData, U32 u32FileLen, SL_FTP_File_TYPE emFileType);
...
*                        -1: Fail
******************************************************************************/
S32 SL_Ftp_REN(U8 *NewName, U8 *OldName);
