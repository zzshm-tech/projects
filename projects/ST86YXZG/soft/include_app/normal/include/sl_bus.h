...
/*I2C*/
#include "sl_app.h"
#define SL_I2cOpen AA.SL_I2cOpen_p
#define SL_I2cClose AA.SL_I2cClose_p
#define SL_I2cWriteByte AA.SL_I2cWriteByte_p
#define SL_I2cReadByte AA.SL_I2cReadByte_p
#define SL_I2cSendData AA.SL_I2cSendData_p
#define SL_I2cReadData AA.SL_I2cReadData_p
/*SPI*/
#define SL_SpiOpen AA.SL_SpiOpen_p
#define SL_SpiClose AA.SL_SpiClose_p
#define SL_SpiWriteData AA.SL_SpiWriteData_p
#define SL_SpiReadData AA.SL_SpiReadData_p
#define SL_SpiActCs AA.SL_SpiActCs_p
#define SL_SpiDeactCs AA.SL_SpiDeactCs_p
#define SL_SpiSetPinState AA.SL_SpiSetPinState_p
#define SL_SpiTxDmaDone AA.SL_SpiTxDmaDone_p
#define SL_SpiRxDmaDone AA.SL_SpiRxDmaDone_p
#define SL_SpiClearTxDmaDone AA.SL_SpiClearTxDmaDone_p
#define SL_SpiClearRxDmaDone AA.SL_SpiClearRxDmaDone_p
#define SL_SpiTxFinished AA.SL_SpiTxFinished_p
#define SL_SpiFlushFifo AA.SL_SpiFlushFifo_p
#define SL_SpiTxIfcChannelRelease AA.SL_SpiTxIfcChannelRelease_p
#define SL_SpiRxIfcChannelRelease AA.SL_SpiRxIfcChannelRelease_p
#define SL_SpiStartInfiniteWriteMode AA.SL_SpiStartInfiniteWriteMode_p
#define SL_SpiStopInfiniteWriteMode AA.SL_SpiStopInfiniteWriteMode_p
#endif
