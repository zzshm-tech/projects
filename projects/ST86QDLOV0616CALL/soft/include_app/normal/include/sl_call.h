...
*************************/
#include "sl_app.h"
#define SL_CallInit AA.SL_CallInit_p
#define SL_CallDial AA.SL_CallDial_p
#define SL_CallAnswer AA.SL_CallAnswer_p
#define SL_CallHangup AA.SL_CallHangup_p
#define SL_CallGetActiveStatus AA.SL_CallGetActiveStatus_p
#endif
