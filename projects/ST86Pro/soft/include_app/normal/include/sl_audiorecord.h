...
typedef enum {
	...
	/*20151102 wyf for pcm record ++*/
	SL_AUDIOREC_FORMAT_PCM
	/*20151102 wyf for pcm record --*/
} SL_AUDIOREC_FORMAT;
typedef struct {
...
//voice record fun 20131105
/*20151102 wyf for pcm record ++*/
typedef void (*SL_AUDIO_PCM_REC_FINISH_CB)(U8* pucData, U32 ulDataLength);
/*20151102 wyf for pcm record --*/
typedef struct {
...
//voice record fun 20131105
	/*20151102 wyf for pcm record ++*/
    SL_AUDIO_PCM_REC_FINISH_CB slAudioPcmRecFinishCb;
    /*20151102 wyf for pcm record --*/
...
//play tts to Opposite  20140303
/*20151102 wyf for pcm record ++*/
#define SL_AudioStreamRecordStart AA.SL_AudioStreamRecordStart_p
#define SL_AudioStreamRecordStop AA.SL_AudioStreamRecordStop_p
/*20151102 wyf for pcm record --*/
#endif
